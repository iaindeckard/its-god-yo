 ...
 *
 * ONE UNAPPROVED DEPARTURE (2026-09-02, DRAFT): a short secondary Cornerstone
 * Partner Program mention + a plain (untracked) link to /cornerstone, added below
 * the main ask. Not yet reviewed — do not treat as part of the 2026-07-28 approval.
 * Matching additions in buildCatholicSchoolEmail, buildFollowupEmail, and
 * buildSchoolsFollowupEmail.
 */
 ...
 * Iain's review, with three deliberate, flagged departures from that draft:
 ...
 *   3. A short secondary Cornerstone Partner Program mention + a plain (untracked)
 *      link to /cornerstone, added 2026-09-02 — DRAFT, pending Iain's copy/legal
 *      review, not yet sent live. See the matching addition in buildEmail,
 *      buildFollowupEmail, and buildSchoolsFollowupEmail (same wording pattern,
 *      audience-adjusted for schools here).
