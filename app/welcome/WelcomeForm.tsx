  ...
  en: {
    ...
    hype: {
      ...
      items: [
        ...
        { emoji: "🎛️", title: "Always your call", body: "Reply STOP anytime to stop messages and cancel billing. Change your time whenever. No guilt, no hoops." },
      ],
  ...
  es: {
    ...
    hype: {
      ...
      items: [
        ...
        { emoji: "🎛️", title: "Siempre tú decides", body: "Responde STOP cuando quieras para detener los mensajes y cancelar la facturación. Cambia tu hora cuando quieras. Sin culpas, sin trabas." },
      ],
