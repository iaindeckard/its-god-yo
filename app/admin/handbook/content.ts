      ...
      },
      {
        ...
        blocks: [
          ...
          { type: "list", items: [
            ...
            "One email, code up front: unlike the church sequence (an intro, then a coded follow-up ~30 days later), a school lead gets a single email that already contains the code and the DM from Him upsell. There is no second touch.",
